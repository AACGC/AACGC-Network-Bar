...
$text1 .= "
<b><a style='cursor:hand; cursor:pointer; text-decoration:none;' href='admin_new.php'>>> Create Link <<</a></b>";
} else {
 $text1 .="
<a style='cursor:hand; cursor:pointer; text-decoration:none;' href='admin_new.php'>Create Link</a>";}
...
{$text1 .= "
<b>
<a style='cursor:hand; text-decoration:none' href='admin_edit.php'>>> Edit Link <<</a>
</b>";}
else
{$text1 .= "
<a style='cursor:hand; text-decoration:none' href='admin_edit.php'>Edit Link</a>";}
